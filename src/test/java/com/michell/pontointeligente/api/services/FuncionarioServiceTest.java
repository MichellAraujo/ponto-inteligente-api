...
import com.michell.pontointeligente.api.repositories.EmpresaRepository;
...
public class FuncionarioServiceTest {
	...
	public void testBuscarFuncionarioPorCpf() {
		Optional<Funcionario> funcionario = this.funcionarioService.buscarPorCpf("29241173474");
		assertTrue(funcionario.isPresent());
	}
