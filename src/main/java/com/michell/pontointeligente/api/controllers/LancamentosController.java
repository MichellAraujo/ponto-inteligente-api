package com.michell.pontointeligente.api.controllers;
...
import com.michell.pontointeligente.api.enums.TipoEnum;
import com.michell.pontointeligente.api.response.Response;
...
public class LancamentosController {
	...
	private static final Logger log = LoggerFactory.getLogger(LancamentosController.class);
	 ...
	 */
	@GetMapping(value = "/{id}")
	public ResponseEntity<Response<LancamentoDto>> listarPorId(@PathVariable("id") Long id) throws NotFoundException {
		...
		if (!lancamento.isPresent()) {
			...
			response.getError().add("Lançamento não encontrado para o id " + id);
	...
	public ResponseEntity<Response<LancamentoDto>> adicionar(@Valid @RequestBody LancamentoDto lancamentoDto,
			BindingResult result) throws ParseException, NotFoundException {
	...
	public ResponseEntity<Response<LancamentoDto>> atualizar(@PathVariable("id") Long id,
			@Valid @RequestBody LancamentoDto lancamentoDto, BindingResult result) throws ParseException, NotFoundException {
	...
	public ResponseEntity<Response<String>> remover(@PathVariable("id") Long id) throws NotFoundException {
		...
		if (!lancamento.isPresent()) {
			...
			response.getError().add("Erro ao remover lançamento. Registro não encontrado para o id " + id);
			return ResponseEntity.badRequest().body(response);
		}
	 ...
	 * @throws NotFoundException 
	 */
	private Lancamento converterDtoParaLancamento(LancamentoDto lancamentoDto, BindingResult result) throws ParseException, NotFoundException {
