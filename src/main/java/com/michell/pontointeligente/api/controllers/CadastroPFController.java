...
import com.michell.pontointeligente.api.dtos.CadastroPFDto;
import com.michell.pontointeligente.api.entities.Empresa;
import com.michell.pontointeligente.api.entities.Funcionario;
import com.michell.pontointeligente.api.enums.PerfilEnum;
import com.michell.pontointeligente.api.response.Response;
import com.michell.pontointeligente.api.services.EmpresaService;
import com.michell.pontointeligente.api.services.FuncionarioService;
import com.michell.pontointeligente.api.utils.PasswordUtils;
...
public class CadastroPFController {
	...
	public ResponseEntity<Response<CadastroPFDto>> cadastrar(@Valid @RequestBody CadastroPFDto cadastroPFDto,
		...
		if (result.hasErrors()) {
			log.error("Erro validando dados de cadastro Pessoa Física: {}", result.getAllErrors());
	...
	private CadastroPFDto converterCadastroPFDto(Funcionario funcionario) {
		...
		funcionario.getQtdHorasTrabalhoDiaOpt().ifPresent(
				qtdHorasTrabDia -> cadastroPFDto.setQtdHorasAlmoco(Optional.of(Float.toString(qtdHorasTrabDia))));
		funcionario.getValorHoraOpt()
				.ifPresent(valorHora -> cadastroPFDto.setQtdHorasAlmoco(Optional.of(valorHora.toString())));
